...
<?php if ( melina_has_featured_posts() ) :
	...
	<div id="featured-content-area" class="featured-content-area">
		<div class="featured featured--carousel-v3">
			<div class="container">
				<div id="carousel-v3" class="carousel">
					...
					foreach ( (array) $featured_posts as $order => $post ) :
						...
						<article class="carousel__item carousel-item<?php if ( has_post_thumbnail() && ! post_password_required() ) : ?> carousel-item--has-thumbnail<?php endif; ?>">
							<?php melina_post_thumbnail( 'post-thumbnail', 'carousel-item__thumbnail', array( 'sizes' => '(max-width: 479px) 90vw, (max-width: 599px) 432px, (max-width: 767px) 536px, (max-width: 959px) 688px, (max-width: 1023px) 768px, (max-width: 1279px) 840px, 1080px' ), true ); ?>
