 ...
 * Type of layout: "First large then two-column grid (full-width)".
 *
 * @package Melina
 */
	...
	while ( have_posts() ) : the_post();
	 	...
	 	if ( $i == 0 ) : ?>
			...
			<article class="post-card post-card--wide<?php if ( has_post_thumbnail() && ! post_password_required() ) : ?> post-card--has-thumbnail<?php endif; ?>">
				<?php melina_post_thumbnail( 'post-thumbnail', 'post-card__thumbnail', array( 'sizes' => '(max-width: 479px) 90vw, (max-width: 599px) 432px, (max-width: 767px) 536px, (max-width: 959px) 688px, (max-width: 1023px) 768px, 1172px' ), true ); ?>
